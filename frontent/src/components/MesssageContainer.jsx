...
//   // ■ FIX: If no user is selected, show the Welcome Screen and STOP here.
//   // This prevents the frozen/broken chat box on refresh.
//   if (!selectedUser) {
//     return (
//       <div className='flex-1 min-h-0 flex flex-col items-center justify-center px-4 py-6 text-center bg-slate-700 rounded-lg mx-2'>
...
//   // If a user IS selected, render the full chat
//   return (
...
//           <button
//             onClick={onBack}
//             className='md:hidden text-white text-2xl hover:bg-white/10 p-1 rounded-full active:scale-95 transition'
//           >
...
//       {/* MESSAGES AREA - No wrapper div! Messages.jsx handles its own scroll */}
//       <Messages />
